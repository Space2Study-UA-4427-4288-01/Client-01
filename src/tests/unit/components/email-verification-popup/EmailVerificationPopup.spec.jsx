...
describe('EmailVerificationPopup', () => {
  ...
  it('should render when open is true', () => {
    ...
    expect(screen.getByText('Email has been successfully verified!')).toBeInTheDocument()
  ...
  it('should not render when open is false', () => {
    ...
    expect(screen.queryByText('Email has been successfully verified!')).not.toBeInTheDocument()
  })
